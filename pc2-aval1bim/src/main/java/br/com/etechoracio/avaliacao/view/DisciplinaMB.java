...
public class DisciplinaMB extends BaseMB {
	...
	protected void postConstruct() {
		List<Professor> mamaodocinho = professorSB.findAll();
		professores = new DualListModel<Professor>(mamaodocinho, new ArrayList<Professor>());
	}
	...
	public void onSave() {
		...
		if (professores.getTarget().size() > 2) {
			...
			showErrorMessage("Erroooo AAAAAAAAAA");
